        ...
        <div class="container">
            ...
            <form>
                <div class="mb-3">
                    ...
                    <div id="emailHelp" class="form-text">Enter the title of the comic you wish to add</div>
                </div>
                <div class="mb-3">
                ...
                <div class="mb-3">
                    <label for="comicSeries" class="form-label">Title</label>
                    <input name="series" type="text" class="form-control" id="comicSeries" aria-describedby="Series">
                    <div id="emailHelp" class="form-text">Enter the series the comic is part of</div>
                </div>
                <div class="mb-3">
                    ...
                    <div id="emailHelp" class="form-text">Enter the price of the comic you wish to add</div>
                </div>
                <div class="mb-3">
                    ...
                    <div id="emailHelp" class="form-text">Add the URL of the cover image</div>
                </div>
                {{-- <div class="mb-3">
                    <label for="comicSaleDate" class="form-label">Sale date</label>
                    <input type="text" class="form-control" id="comicSaleDate" aria-describedby="SaleDate">
                    <div id="emailHelp" class="form-text">Add the comic sell date in the YYYY-MM-DD format</div>
                </div> --}}
                <div class="mb-3">
